...
# To submit:
# sbatch --job-name=petprep --output=petprep_%j.out --mail-type=END,FAIL ./mlsc-petprep-hmc.bash
...
INPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/ds004869/ds004869-download
OUTPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/ds004869/petprep-output

...
# `mlsc-recon-all.bash` failed on 4 subjects with a `ERROR: FreeSurfer license file not found`
# Must have been a network filesystem glitch.  This reruns those 4 subjects

# To submit:
# sbatch --job-name=cox2_recon --output=cox2_recon_%j.out --mail-type=END,FAIL ./mlsc-recon-all-take2.bash
...
SUB_LIST=/autofs/vast/gerenuk/pwighton/pet/miba/cox2/recon-all-sub-list-take2.txt

...
# To submit:
# sbatch --job-name=petprep4733 --output=petprep4733_%j.out --mail-type=END,FAIL ./mlsc-petprep-hmc-ds004733.bash
...
INPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/leucine/ds004733-download
OUTPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/leucine/petprep-output/ds004733

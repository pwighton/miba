...
# To submit:
# sbatch --job-name=petprep4731 --output=petprep4731_%j.out --mail-type=END,FAIL ./mlsc-petprep-hmc-ds004731.bash
...
INPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/leucine/ds004731-download
OUTPUT_DIR=/autofs/vast/gerenuk/pwighton/pet/leucine/petprep-output/ds004731
